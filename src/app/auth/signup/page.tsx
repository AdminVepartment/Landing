...
export default function SignUpPage() {
  ...
  function handleCreateAccount() {
    log({ icon: "account", title: "Account created", dept: "System", context: "User registration completed" });
    ...
    <div className="relative min-h-screen bg-background flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center px-4 sm:px-6 py-12">
        <div className="w-full max-w-[440px]">
          ...
          <div className="relative flex flex-col gap-5 mb-8">
            ...
            <div className="pt-1">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="font-mono text-[9px] text-foreground-dim tracking-[0.1em] uppercase">
                  Organization
                </span>
                <div className="flex-1 h-px bg-border" />
              </div>
              <FormField
                ...
                optional
                hint="Used to name your first workspace"
              />
            </div>
          </div>
          ...
          {/* CTA */}
          <Button variant="solid" size="lg" className="w-full h-11 mb-8" onClick={handleCreateAccount}>
            Create Account
          </Button>
          ...
          <div className="pt-6 border-t border-border">
            <p className="text-body-sm text-foreground-muted">
              ...
              <Link href="/auth/signin" className="text-foreground hover:text-primary transition-colors">
                Sign In →
              </Link>
            </p>
          </div>
